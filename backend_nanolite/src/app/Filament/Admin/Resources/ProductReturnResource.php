            ...
            ->schema([
               Select::make('department_id')
                ...
                TextInput::make('amount')
                    ...
                    ->numeric()
                    ->prefix('Rp')
                    ->rules(['min:1']) // nilai tidak boleh nol
                    ->required(),
        ...
        return $table
            ...
            ->actions([
                ...
                Action::make('downloadExcel')                // <<< TAMBAHAN EXCEL
                    ...
                    ->url(fn (ProductReturn $record) => Storage::url($record->return_excel)) // <<< TAMBAHAN EXCEL
                    ->openUrlInNewTab()                      // <<< TAMBAHAN EXCEL
                    ->visible(fn (ProductReturn $record) => ! empty($record->return_excel)), // <<< TAMBAHAN EXCEL
            ])
