...
class OptionItem {
  ...
  final int? employeeId;   // 🔥 baru
  final int? departmentId; // 🔥 baru
  final String? phone;
  ...
  for (final c in idCandidates) {
    ...
    return OptionItem(
      ...
      employeeId: json['employee_id'] != null ? int.tryParse('${json['employee_id']}') : null,
      departmentId: json['department_id'] != null ? int.tryParse('${json['department_id']}') : null,
